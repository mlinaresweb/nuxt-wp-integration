  ...
  <div class="bg-white p-12 rounded-lg mx-12 ">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 overflow-hidden  lg:max-h-[60vh] md:max-h-[62vh] max-h-[62vh] -mr-32"> 
        ...
        <div class="relative p-6  px-6 ">
          <p class=" block font-sans  font-semibold leading-snug tracking-normal text-white antialiased ">
            Alquiler de BMW
          </p>
          <p class="-mb-2 text-left text-orange-400">€150 / al dia</p>
        </div>
      </div>

        
      <div class="relative grid h-[22rem] w-full max-w-[28rem] flex-col items-end justify-start overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
        <div class="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('https://i.ibb.co/TrFFCV4/porsche.webp')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none">
          <div class="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-t from-black/100 via-black/0"></div>
        </div>
        <div class="relative p-6  px-6 ">
          <p class=" block font-sans  font-semibold leading-snug tracking-normal text-white antialiased ">
      ...
      <div class="relative grid h-[22rem] w-full max-w-[28rem] flex-col items-end justify-start overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
        <div class="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('https://i.ibb.co/XLRC2h3/mustang.webp')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none">
          <div class="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-t from-black/100 via-black/0"></div>
        </div>
        <div class="relative p-6  px-6 ">
          <p class=" block font-sans  font-semibold leading-snug tracking-normal text-white antialiased ">
      ...
      <div class="relative grid h-[22rem] w-full max-w-[28rem] flex-col items-end justify-start overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
        <div class="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('https://i.ibb.co/C5dDVtS/lambo.webp')] bg-cover bg-clip-border bg-center text-gray-700 shadow-none">
          <div class="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-t from-black/100 via-black/0"></div>
        </div>
        <div class="relative p-6  px-6 ">
          <p class=" block font-sans  font-semibold leading-snug tracking-normal text-white antialiased ">
            Alquiler de Lamborghini
          </p>
          <p class="-mb-2 text-left text-orange-400">€150 / al dia</p>
        </div>
      </div>
