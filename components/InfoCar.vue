<template>
    <div class="flex h-screen">
      <div class="w-full sm:w-1/2 bg-luxury-blue p-10">
        <h2 class="text-white text-3xl mb-4 md:mx-14 lg:mx-14 mt-6">Alquilar un coche de lujo nunca fue tan fácil.</h2>
        <p class="text-white mb-10 md:mx-14 lg:mx-14 mt-10">
        ...
        <ul class="grid gap-4 sm:space-y-4 md:mx-14 lg:mx-14 mt-10 sm:grid-cols-1 grid-cols-2">
