    ...
    <footer class="bg-luxury-blue text-white p-8 ">
      <div class="container mx-auto">
        <div class="flex flex-col space-y-4">
          ...
          <a
            href="#"
            class="block rounded-lg bg-white px-6 py-3 text-sm font-medium text-black shadow hover:text-rose-700 focus:outline-none focus:ring active:text-rose-500 sm:w-auto"
          >
            Enviar
          </a>
        </div>
          ...
          <div class="flex justify-center items-center pb-4 pt-4">
                <NuxtImg loading="lazy" src="/logo.png" alt="Logo" class="mr-4" width="20px" height="30px"/>
