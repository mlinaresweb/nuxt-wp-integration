<template>
    <nav class="absolute top-0 left-0 right-0 z-20 flex items-center justify-center h-16 px-8 bg-black bg-opacity-70 ">
      <div class="flex items-center justify-between w-full mx-16">
        ...
        <a href="#" class="md:hidden">
          <img src="https://i.ibb.co/T8FGxdn/logo.webp" alt="Logo"  width="94" height="144" class="h-auto w-auto">
        </a>
  ...
  <div class="flex items-center justify-center space-x-4 md:justify-start w-full md:w-auto">
        <img src="https://i.ibb.co/T8FGxdn/logo.webp" alt="Logo"  width="94" height="144" class="h-auto w-auto hidden md:block"> <!-- Oculta en móviles -->
